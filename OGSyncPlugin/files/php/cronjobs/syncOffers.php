...
register_shutdown_function(function () use ($boolLockFileSystemEnabled, $lockFile, $beginTime) {
	...
	$wpdb->insert('cronjobs', [
		...
		'boolGiveLastCron' => OGSyncSettingsData::$boolGiveLastCron,
		'objectsCreated' => OGSyncSettingsData::$intObjectsCreated,
		'objectsUpdated' => OGSyncSettingsData::$intObjectsUpdated,
