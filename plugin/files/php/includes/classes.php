...
class SettingsPage
{
    ...
    {?>
        <div class='wrap text'>
            ...
            <form action="options.php">
                <?php
                settings_fields('PixelPlusOGPlugin');
    ...
    {
        add_settings_section('ppOGFirstSection', null, null, 'pixelplus-og-plugin');
        add_settings_field('ppOGLicienceKey', 'Licencie sleutel', array($this, 'htmlLicienceKey'), 'pixelplus-og-plugin', 'ppOGFirstSection');
        register_setting('PixelPlusOGPlugin', 'ppOGLicienceKey', array('sanitize_callback' => 'sanitize_text_field', 'default' => ''));

    }

    function htmlLicienceKey(): void
    {?>
        <input type='text' name='ppOGLicienceKey' value='<?php echo get_option('ppOGLicienceKey'); ?>'>
    <?php }
}
